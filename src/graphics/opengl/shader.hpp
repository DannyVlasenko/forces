...
namespace opengl
{
	...
	public:
		...
		void set_uniform_3f(const char* name, GLfloat f0, GLfloat f1, GLfloat f2) const;
		void set_uniform_mat4(const char* name, const glm::mat4& mat) const;
		void set_uniform_mat3(const char* name, const glm::mat3& mat) const;
